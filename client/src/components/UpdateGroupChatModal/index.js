...
const UpdateGroupChatModal = ({ fetchAgain, setFetchAgain, fetchMessages }) => {
    ...
    const handleRename = async () => {
        ...
        try {
            ...
            const { data } = await axios.put("https://chatapp-ag.onrender.com/rename",
                {
                    name: groupChatName,
                    id: selectedChat._id,
                },
    ...
    const handleAddUser = async (user1) => {
        ...
        try {
            ...
            const { data } = await axios.put("https://chatapp-ag.onrender.com/groupadd",
                {
                    id: selectedChat._id,
                    user: user1._id,
                },
    ...
    const handleRemove = async (user1) => {
        ...
        try {
            ...
            const { data } = await axios.put("https://chatapp-ag.onrender.com/groupremove",
                {
                    id: selectedChat._id,
